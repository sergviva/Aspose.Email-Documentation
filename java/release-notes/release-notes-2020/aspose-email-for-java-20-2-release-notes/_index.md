---
title: Aspose.Email for Java 20.2 Release Notes
type: docs
weight: 50
url: /java/aspose-email-for-java-20-2-release-notes/
---


{{% alert color="primary" %}} 

This page contains release notes information for Aspose.Email for Java 20.2.
