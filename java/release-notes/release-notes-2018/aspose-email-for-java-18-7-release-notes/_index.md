...
type: docs
weight: 60
url: /java/aspose-email-for-java-18-7-release-notes/
---
...
| :- | :- | :- |
|EMAILNET-38952|Provision of usage of http proxy in email clients ([SMTP](/email/java/connecting-to-smtp-server/#connectingtosmtpserver-connectingtosmtpserverviahttpproxyserver), [IMAP](/email/java/connecting-to-imap-server/#connectingtoimapserver-connecttoserverusinghttpproxy), [POP3](/email/java/connecting-to-pop3-server/#connectingtopop3server-connecttopop3serverviahttpproxy))|New Feature|
...
|EMAILJAVA-34385|Provide [MailMessage like MHT output](/email/java/working-with-outlook-tasks/#workingwithoutlooktasks-convertingoutlooktasktomht) for MapiTask|Enhancement|
