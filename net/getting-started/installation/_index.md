...
In the package manager console, you can also use the command “**Update-Package Aspose.Email.NET**” and press enter to check for any updates to the Aspose.Email package and install them if present. You can also add the "-prerelease" suffix to update the latest release.
...
1. Click the **Change/Remove** button to remove Aspose.Email.
