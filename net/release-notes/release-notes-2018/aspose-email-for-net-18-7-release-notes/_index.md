...
type: docs
weight: 60
url: /net/aspose-email-for-net-18-7-release-notes/
---
...
| :- | :- | :- |
|EMAILNET-38952|Provision of usage of http proxy in email clients ([POP3](/email/net/connect-to-pop3-server/#connecttopop3server-connectingtoserverviahttpproxy), [SMTP](/email/net/connecting-to-smtp-server/#connectingtosmtpserver-connectingtoserverviahttpproxyserver), [IMAP](/email/net/connecting-to-imap-server/#connectingtoimapserver-connectingtoserverviahttpproxy))|New Feature|
|EMAILNET-39044|EWS: Create unified method for MAPI items fetching|Enhancement|
|EMAILNET-39008|Option to [set font in text only mails](/email/net/loading-and-saving-message/#loadingandsavingmessage-changingfontwhileconvertingtomht)|Enhancement|
|EMAILNET-39016|Provide [MailMessage like MHT output for MapiTask](/email/net/working-with-outlook-tasks/#workingwithoutlooktasks-convertingtasktomht)|Enhancement|
